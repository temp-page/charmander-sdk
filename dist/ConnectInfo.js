...
class ConnectInfo {
    ...
    clear() {
        (0, service_2.clearCache)();
    }
    /**
     * 获取 ERC20 API
     */
    erc20() {
        return this.create(service_2.Erc20Service);
    }
    /**
     * 获取交易API
     */
    tx() {
        return this.create(service_2.TransactionService);
    }
    /**
     * multiCall service
     */
    multiCall() {
        return this.create(service_2.MultiCallContract);
    }
    get provider() {
        if (this._status)
    ...
    async addToken(tokenAddress) {
        ...
        service_2.Trace.debug('token info', token);
        try {
