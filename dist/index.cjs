...
let LaunchpadApi = class {
  ...
  async poolDetail(pool, account = "") {
    ...
    poolDetail.publicAllocation = BigNumber__default.max(new BigNumber__default(lodashExports.get(launchpadInfo, "pool_size", "0")).minus(poolInfo.whiteListQuota), "0").toFixed();
...
exports.DashboardApi = class DashboardApi {
  ...
  async protocolData() {
    ...
    const feesOneWindowAgo = new BigNumber__default(lodashExports.get(parsed24, "totalFeesUSD", "0")).minus(lodashExports.get(parsed24, "totalProtocolFeesUSD", "0")).minus(new BigNumber__default(lodashExports.get(parsed48, "totalFeesUSD", "0")).minus(lodashExports.get(parsed48, "totalProtocolFeesUSD", "0")));
