...
declare const RUSDYAbi: JsonFragment[];
declare const WETHAbi: JsonFragment[];
declare const AgniProjectPartyRewardAbi: JsonFragment[];
...
declare class AgniProjectPartyRewardApi {
    baseApi: BaseApi;
    constructor();
...
interface ProjectPartyReward {
    currentEpoch: number;
    startTime: number;
    epochTime: number;
    epochCount: number;
    pools: ProjectPartyRewardPool[];
}
interface ProjectPartyRewardPool {
    epoch: number;
    poolAddress: string;
    userAddress: string;
    userCount: number;
...
interface ProjectPartyRewardClaim {
    id: string;
    timestamp: string;
    hash: string;
    epoch: string;
...
interface ProjectPartyRewardInfo {
    infos: {
        claim: boolean;
        amount: string;
        epoch: string;
...
declare class ProjectPartyRewardResult {
    currentEpoch: number;
    startTime: number;
    epochTime: number;
    epochCount: number;
...
interface ProjectPartyRewardUserPool extends ProjectPartyRewardPool {
    token0Stake: string;
    token1Stake: string;
}
declare class ProjectPartyRewardMyListResult {
    totalReward: string;
    unClaim: string;
...
declare class RUSDY extends BaseAbi {
    constructor(connectInfo: ConnectInfo);
