...
declare function getCurrentConnect(): ConnectInfo;
...
interface GasCost {
    gasEstimate: bigint;
    totalGasCostNativeCurrency: CurrencyAmount<Currency>;
}
...
type RouteWithQuote = RouteWithoutQuote & RouteQuote;
...
declare class SwapV3Api {
    ...
    getCandidatePoolsByToken(tokenA: Token, tokenB: Token): Promise<V3PoolWithTvl[]>;
    getCandidatePoolsByPair(tokenA: Token, tokenB: Token): Promise<V3PoolWithTvl[]>;
    test(): QuoteProvider;
}
...
declare class BasicException extends Error {
     ...
     * @param detail
     */
    constructor(msg?: string, sourceError?: Error | null, code?: number, detail?: any);
    get code(): number;
    /**
     * 错误信息
     */
