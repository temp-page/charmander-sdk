import { updateCurrentAddressInfo } from "../Constant.mjs";
import { ConnectManager } from "../WalletConnect.mjs";
import { AddressInfo, StorageProvider, Trace } from "../service/index.mjs";
...
export function initAddress(ENV) {
  if (ENV === "dev" || ENV === "test") {
