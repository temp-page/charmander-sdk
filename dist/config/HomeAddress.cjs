...
exports.TESTNET_ADDRESSES = exports.MAINNET_ADDRESSES = void 0;
...
const TESTNET_ADDRESSES = exports.TESTNET_ADDRESSES = {
  ...
  tokens: ["0xEa12Be2389c2254bAaD383c6eD1fa1e15202b52A", "0x3e163F861826C3f7878bD8fa8117A179d80731Ab", "0x82a2eb46a64e4908bbc403854bc8aa699bf058e9", "0x74a0e7118480bdff5f812c7a879a41db09ac2c39", "0xd0c049ee0b0832e5678d837c1519e1b2380e32e4", "0x113667C49c053230D3232AC7d74F471Dcd42f11E"]
};
const MAINNET_ADDRESSES = exports.MAINNET_ADDRESSES = {
  ...
  tokens: ["0x78c1b0c915c4faa5fffa6cabf0219da63d7f4cb8", "0x201eba5cc46d216ce6dc03f6a759e8e766e956ae", "0xdeaddeaddeaddeaddeaddeaddeaddeaddead1111", "0x09bc4e0d864854c6afb6eb9a9cdf58ac190d0df9"]
};
function initAddress(ENV) {
  if (ENV === "dev" || ENV === "test") {
    const addressInfo = new _service.AddressInfo();
    ...
    addressInfo.baseTradeToken = ["0xEa12Be2389c2254bAaD383c6eD1fa1e15202b52A", "0x3e163f861826c3f7878bd8fa8117a179d80731ab", "0x82a2eb46a64e4908bbc403854bc8aa699bf058e9", "0x74a0e7118480bdff5f812c7a879a41db09ac2c39"];
    if (ENV === "dev") addressInfo.storage = new _service.StorageProvider("node");
    if (ENV === "test") addressInfo.storage = new _service.StorageProvider("web");
    (0, _Constant.updateCurrentAddressInfo)(addressInfo);
    ...
    addressInfo.baseTradeToken = ["0x78c1b0C915c4FAA5FffA6CAbf0219DA63d7f4cb8", "0x201EBa5CC46D216Ce6DC03F6a759e8E766e956aE", "0x09Bc4E0D864854c6aFB6eB9A9cdF58aC190D0dF9", "0xdEAddEaDdeadDEadDEADDEAddEADDEAddead1111"];
    ...
    if (ENV === "prod") addressInfo.storage = new _service.StorageProvider("web");
    if (ENV === "prod_node") addressInfo.storage = new _service.StorageProvider("node");
    (0, _Constant.updateCurrentAddressInfo)(addressInfo);
  } else {
    throw new Error(`${ENV} is not support`);
  }
  _service.Trace.debug("address config init", ENV);
  _WalletConnect.ConnectManager.chainMap["Mantle Testnet"] = [{
    chainId: "0x1389",
  ...
  _WalletConnect.ConnectManager.chainMap.Mantle = [{
    chainId: "0x1388",
    chainName: "Mantle",
    nativeCurrency: {
      name: "MNT",
  ...
  _WalletConnect.ConnectManager.chainMap.Goerli = "0x5";
  _WalletConnect.ConnectManager.chainMap.sepolia = "0xaa36a7";
}