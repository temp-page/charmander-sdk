...
const fixed_reverse_heap_js_1 = __importDefault(require("mnemonist/fixed-reverse-heap.js"));
const queue_js_1 = __importDefault(require("mnemonist/queue.js"));
...
function getBestSwapRouteBy(tradeType, percentToQuotes, percents, chainId, by, { maxSplits = 4, minSplits = 0 }) {
    ...
    const bestSwapsPerSplit = new fixed_reverse_heap_js_1.default(Array, (a, b) => {
