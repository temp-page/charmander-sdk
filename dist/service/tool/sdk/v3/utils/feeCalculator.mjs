import { MAX_FEE, ONE_HUNDRED_PERCENT, ZERO_PERCENT } from "../internalConstants.mjs";
import { CurrencyAmount, Fraction } from "../../fractions/index.mjs";
import { MaxUint256, ZERO } from "../../constants.mjs";
import { invariant } from "../../../math/Common.mjs";
import { Tick } from "../tick.mjs";
import { TickList } from "./tickList.mjs";
import { PositionMath } from "./positionMath.mjs";
import { TickMath } from "./tickMath.mjs";
import { maxLiquidityForAmounts } from "./maxLiquidityForAmounts.mjs";
...
export function getAverageLiquidity(ticks, tickSpacing, tickLower, tickUpper) {
  ...
  let lastTick = lowerOutOfBound ? new Tick({ index: TickMath.MIN_TICK, liquidityNet: ZERO, liquidityGross: ZERO }) : TickList.nextInitializedTick(ticks, tickLower, true);
