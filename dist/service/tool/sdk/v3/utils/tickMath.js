...
class TickMath {
    ...
    static getSqrtRatioAtTick(tick) {
        (0, Common_1.invariant)(tick >= TickMath.MIN_TICK && tick <= TickMath.MAX_TICK && Number.isInteger(tick), 'TICK');
        ...
        if (tick > 0)
            ratio = constants_1.MaxUint256 / ratio;
        // back to Q96
        return ratio % Q32 > internalConstants_1.ZERO ? ratio / Q32 + internalConstants_1.ONE : ratio / Q32;
    }
    /**
    ...
    static getTickAtSqrtRatio(sqrtRatioX96) {
        (0, Common_1.invariant)(sqrtRatioX96 >= TickMath.MIN_SQRT_RATIO && sqrtRatioX96 < TickMath.MAX_SQRT_RATIO, 'SQRT_RATIO');
