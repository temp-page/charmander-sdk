...
let LaunchpadApi = class LaunchpadApi {
    ...
    async staking(account = '') {
        ...
        const stakeDetail = new vo_2.LaunchpadStakeDetail();
        ...
        stakeDetail.stake = async (connect, amount) => {
            ...
            return connect.create(abi_1.StakingPoolAbi).stakeNativeToken(realAmount);
        };
    ...
    async getPools() {
        ...
        const allProject = res.idoPools
            ...
            .map((item) => {
            const idoPool = new vo_2.IDOPool();
            idoPool.id = item.id;
        ...
        const idoPoolStatistics = new vo_2.IdoPoolStatistic();
    ...
    async getUserDepositedLogsByPool(user, pool) {
        ...
        const userDepositInfo = new vo_2.IDOUserDepositInfo();
    ...
    async poolDetail(pool, account = '') {
        ...
        const depositInfo = new vo_2.IDODepositInfo();
        ...
        const poolDetail = new vo_2.IDOPoolDetail();
