...
let AgniProjectPartyRewardApi = class AgniProjectPartyRewardApi {
    ...
    async result(account) {
        ...
        const pools = await this.baseApi.exchangeGraph(AgniProjectPartyRewardGql_1.AgniProjectPartyQueryPairGQL, { ids: partyReward.pools.map(it => it.poolAddress.toLowerCase()) });
