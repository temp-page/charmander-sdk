...
let PoolV3Api = PoolV3Api_1 = class PoolV3Api {
    ...
    static computePoolAddress(tokenA, tokenB, fee) {
        ...
        const encodedParams = ethers6_1.AbiCoder.defaultAbiCoder().encode(['address', 'address', 'uint24'], [token0.erc20Address(), token1.erc20Address(), fee]);
        const salt = (0, ethers6_1.solidityPackedKeccak256)(['bytes'], [encodedParams]);
        return (0, ethers6_1.getCreate2Address)(agniPoolDeployer, salt, poolInitCodeHash);
    }
    async getPool(datas) {
    ...
    async addLiquidity(token0, token1, account) {
        ...
        addLiquidityV3Info.feeAmount = vo_1.FeeAmount.HIGH;
