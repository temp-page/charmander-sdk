...
let TokenMangerApi = class TokenMangerApi {
    ...
    async tokenPrice(...tokens) {
        ...
        return tokens.map((token) => {
            ...
            const groupByElementElement = (0, get_1.default)(_groupBy, token.erc20Address().toLowerCase(), [])[0];
            if (groupByElementElement) {
                ...
                if ((0, tool_1.eqAddress)(token.erc20Address(), this.WNATIVE().erc20Address())) {
                    return new vo_1.TokenPrice(token, '1', '1');
                }
    ...
    async tokenManager(searchStr = '') {
        ...
        if (search === '') {
            ...
            if ((0, ethers6_1.isAddress)(search)) {
