    ...
    async getTokenPrice(type, swapInfo) {
        ...
        if (type === 'month' || type === 'year' || type === 'day' || type === 'week') {
            ...
            const [token0Prices, token1Prices, token0Price24, token1Price24,] = await Promise.all([
                ...
                block24.number ? this.baseApi.exchangeV3Graph((0, SwapV3Gql_1.GetDerivedPricesGQL)(token0.erc20Address().toLowerCase(), [block24]), {}) : Promise.resolve({}),
                block24.number ? this.baseApi.exchangeV3Graph((0, SwapV3Gql_1.GetDerivedPricesGQL)(token1.erc20Address().toLowerCase(), [block24]), {}) : Promise.resolve({}),
            ]);
