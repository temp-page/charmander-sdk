...
const QuoteProviderFactory_1 = require("./provider/QuoteProviderFactory");
let SwapApi = class SwapApi {
    ...
    async getBestTrade(token0, token1, amount, inputToken, swapConfig) {
        ...
        const quoteProviderFactory = (0, tool_1.mixProxy)(QuoteProviderFactory_1.QuoteProviderFactory);
