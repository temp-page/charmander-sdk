...
exports.RUSDY = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const abi_1 = require("../../abi");
const tool_1 = require("../tool");
const BaseAbi_1 = require("./BaseAbi");
let RUSDY = class RUSDY extends BaseAbi_1.BaseAbi {
    constructor(connectInfo) {
        super(connectInfo, connectInfo.addressInfo.RUSDY, abi_1.RUSDYAbi);
...
exports.RUSDY = RUSDY = __decorate([
    (0, tool_1.CacheKey)('RUSDY'),
