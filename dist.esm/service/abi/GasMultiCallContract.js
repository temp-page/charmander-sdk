...
let GasMultiCallContract = class GasMultiCallContract extends BaseAbi {
    ...
    async multicall(callRequests) {
        ...
        try {
            ...
            for (const callChuck of callRequestsChuck) {
                const { returnData, } = await this.contract.multicall.staticCall(callChuck, { gasLimit: MAX_GAS_LIMIT });
...
GasMultiCallContract = __decorate([
    CacheKey('GasMultiCallContract'),
    __metadata("design:paramtypes", [Function])
], GasMultiCallContract);
export { GasMultiCallContract };
