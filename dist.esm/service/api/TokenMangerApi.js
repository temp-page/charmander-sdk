...
import { CacheKey, STORAGE_KEY_TOKENS, STORAGE_KEY_TOKEN_LIST, Token, Trace, eqAddress, isNullOrBlank, } from '../tool';
import { AgniTokenListSchema, ETH_ADDRESS, TokenListInfo, TokenManagerAddInfo, TokenManagerInfo, TokenPrice, TokenSelectInfo, } from '../vo';
import { BasicException } from '../../BasicException';
import tokens from '../../config/tokens.json';
import { TokenPriceGQL } from './gql';
...
let TokenMangerApi = class TokenMangerApi {
    ...
    async tokenPrice(...tokens) {
        ...
        const { bundles, tokens: tokenPrices, } = await this.baseApi.exchangeGraph(TokenPriceGQL, { addresses });
...
TokenMangerApi = __decorate([
    CacheKey('TokenMangerApi'),
    __metadata("design:paramtypes", [])
], TokenMangerApi);
export { TokenMangerApi };
