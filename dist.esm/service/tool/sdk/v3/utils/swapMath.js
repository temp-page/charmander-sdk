import { MAX_FEE, NEGATIVE_ONE, ZERO } from '../internalConstants';
    ...
    static computeSwapStep(sqrtRatioCurrentX96, sqrtRatioTargetX96, liquidity, amountRemaining, feePips) {
        ...
        if (exactIn) {
            ...
            if (amountRemaining * NEGATIVE_ONE >= returnValues.amountOut) {
                ...
                returnValues.sqrtRatioNextX96 = SqrtPriceMath.getNextSqrtPriceFromOutput(sqrtRatioCurrentX96, liquidity, amountRemaining * NEGATIVE_ONE, zeroForOne);
            }
        }
        ...
        if (exactIn && returnValues.sqrtRatioNextX96 !== sqrtRatioTargetX96) {
            ...
            returnValues.feeAmount = FullMath.mulDivRoundingUp(returnValues.amountIn, BigInt(feePips), MAX_FEE - BigInt(feePips));
        }
