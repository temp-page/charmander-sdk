...
class WalletConnect {
    ...
    async privateWallet() {
        ...
        connectInfo.chainId = parseInt((await provider.getNetwork()).chainId.toString());
    ...
    async web3Provider() {
        ...
        connectInfo.chainId = parseInt((await web3Provider.getNetwork()).chainId.toString());
        connectInfo.msg = 'success';
    ...
    static async connectMetaMask() {
        ...
        const provider = new ethers_1.BrowserProvider(_ethereum, 'any');
    ...
    async connect() {
        try {
            ...
            else if (this.wallet instanceof ethers_1.BrowserProvider) {
